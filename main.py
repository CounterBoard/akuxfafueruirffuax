...
print("=" * 50)
print("🚀 ДИАГНОСТИКА: ПРОВЕРКА СТРУКТУРЫ ОТВЕТОВ")
print("=" * 50)
print(f"📱 Инстанс: {ID_INSTANCE}")
print(f"💬 Чат MAX: {MAX_CHAT_ID}")
print("=" * 50)
print("🟢 Запущено. Отправьте сообщение с ответом в Max...\n")
    ...
    try:
        ...
        if response.status_code == 200 and response.text and response.text != "null":
            ...
            if receipt_id:
                ...
                # Выводим структуру messageData полностью
                body = data.get('body', {})
                message_data = body.get('messageData', {})
                
                print("📦 Содержимое messageData:")
